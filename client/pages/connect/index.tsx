...
function App() {
  ...
  //1. websocket 연결 시도
  //2. websocket 연결완료되면 서버로 Login send
  //3. 서버에서 userId를 발급받고 setState 이때 userId : signaling, type : UserId, data : uuid
  //4. 상대방 정보를 요청한다. userId : data1, type : NewMember, toUid : signaling, data : Join
  //5. 서버에서는 상대방의 userId를 전달해준다. 이때 type : NewMember. 이때 호출되는 함수는 handleNewMemberAndOffer
  //6. rtc 연결을 시도한다. 한쪽은 createOffer, 한쪽은 setRemoteDescription
